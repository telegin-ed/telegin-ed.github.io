...
## Часть 1. Стратегическое проектирование
...
### Глава 2. Экcпертные знания о предметной области
...
##### Сложности использования единого языка
...
#### Проблема противоречивых моделей
...
#### Связь между поддоменами и ограниченными контекстами
...
## Часть 4. Взаимоотношения с другими методологиями и паттернами
